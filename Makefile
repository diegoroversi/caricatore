...
INSTALL_DIR = $(HOME)/src/arduino-0018
MY_LIB_DIR = $(HOME)/sketchbook/libraries
PORT = /dev/ttyUSB*
UPLOAD_RATE = 57600
...
# Add -I options for the libraries you need 
# LIBINCLUDES = -I$(MY_LIB_DIR)/CapacitiveSense/ -I$(MY_LIB_DIR)/Colours/
...
CINCS = -I$(ARDUINO) $(LIBINCLUDES)
CXXINCS = -I$(ARDUINO) $(LIBINCLUDES)
